...
```javascript
place = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-place@v0.1.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-place@v0.1.2-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/array-base-place/actions/workflows/test.yml/badge.svg?branch=v0.1.2
[test-url]: https://github.com/stdlib-js/array-base-place/actions/workflows/test.yml?query=branch:v0.1.2
